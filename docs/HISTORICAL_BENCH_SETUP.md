# Historical bench setup — archived reference

The following is the setup record before the 2026-09-10 documentation refresh.
Its trial values and statements about future tests are historical. Do not use
it as today's app startup instructions. Use [STARTUP](STARTUP.md),
[USAGE](USAGE.md) and [ROBOT_SETUP](ROBOT_SETUP.md).
