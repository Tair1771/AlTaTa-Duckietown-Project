...
class ReadinessTests(LaneTests):
    ...
    def test_invalid_parameters_fail_before_subscribing(self):
        bad = {
            ...
            "junction_straight_encoder_balance": ["true", 1, None],
            ...
            "junction_reacquire_max_error": [0, -0.1, 1.01, float("nan")],
            "junction_straight_speed": [0, .19, float("nan")],
            "junction_straight_approach_max_steering": [-.01, .09, float("nan")],
            "junction_straight_encoder_balance_gain": [-.01, 1.01, float("nan")],
            "junction_straight_encoder_balance_max": [-.01, .09, float("nan")],
            "junction_straight_encoder_balance_min_ticks": [0, float("nan")],
